...
Let's assume we want to use a linear filter:
...
Suppose we measure $d = h_\theta + n$, where our model for $h_\theta = h(t; \theta)$ depends on several parameter (typically, between 10 and 15).
